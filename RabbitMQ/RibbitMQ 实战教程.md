...
## *附加.Docker下部署RabbitMQ集群

~~~
步骤1~4开启普通镜像
步骤一：安装RabbitMQ到集群
docker run -d --hostname rabbit1 --name myrabbit1 -p 15672:15672 -p 5672:5672 -e RABBITMQ_ERLANG_COOKIE='rabbitcookie' rabbitmqrabbitmq:management
...
步骤四：在网页中开启RabbitMQ后台管理界面：http://192.168.0.109:15672

步骤五：开启镜像模式
如下图所示
~~~

![开启镜像模式第一步](D:\笔记\RabbitMQ\images\开启镜像模式第一步.png)

​																			【开启镜像模式第一步】

![开启镜像模式第二步](D:\笔记\RabbitMQ\images\开启镜像模式第二步.png)

​																			【开启镜像模式第二步】

![image-20200427232413741](D:\笔记\RabbitMQ\images\添加队列.png)

​																			【添加队列】

![开启镜像模式成功](D:\笔记\RabbitMQ\images\开启镜像模式成功.png)
